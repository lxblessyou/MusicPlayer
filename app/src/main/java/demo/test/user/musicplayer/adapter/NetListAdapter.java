...
public class NetListAdapter extends BaseAdapter{
    ...
    public NetListAdapter(Context context, List<Mp3Info> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.iv_down_arrows = convertView.findViewById(R.id.iv_down_arrows);
...
//        holder.tv_duration.setText(MediaUtil.millToSecond(duration));
        holder.iv_down_arrows.setVisibility(View.VISIBLE);
